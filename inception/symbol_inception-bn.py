...
def ConvFactory(data, num_filter, kernel, stride=(1,1), pad=(0, 0), name=None, suffix=''):
    ...
    bn = mx.symbol.BatchNorm(data=conv, name='bn_%s%s' %(name, suffix), fix_gamma=False)
...
def get_symbol(num_classes=1000, dataset='imagenet'):
    ...
    conv1 = ConvFactoryLR0(data=data, num_filter=64, kernel=(7, 7), stride=(2, 2), pad=(3, 3), name='conv1')
    ...
    conv2red = ConvFactoryLR0(data=pool1, num_filter=64, kernel=(1, 1), stride=(1, 1), name='conv2red')
    conv2 = ConvFactoryLR0(data=conv2red, num_filter=192, kernel=(3, 3), stride=(1, 1), pad=(1, 1), name='conv2')
